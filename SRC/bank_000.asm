...
; Note: the only used RST is RST_28
SECTION "ROM Bank $000 - RST_00", ROM0[$0000]
RST_00:: jp bootRoutine

SECTION "ROM Bank $000 - RST_08", ROM0[$0008]
RST_08:: jp bootRoutine

SECTION "ROM Bank $000 - RST_10", ROM0[$0010]
RST_10::

SECTION "ROM Bank $000 - RST_18", ROM0[$0018]
RST_18::

SECTION "ROM Bank $000 - RST_20", ROM0[$0020]
RST_20::

SECTION "ROM Bank $000 - RST_28", ROM0[$0028]
...
; RST_30 starts partway inside RST_28

SECTION "ROM Bank $000 - RST_38", ROM0[$0038]
RST_38::

SECTION "ROM Bank $000 - VBlankInterrupt", ROM0[$0040]
VBlankInterrupt:: jp VBlankHandler

SECTION "ROM Bank $000 - LCDCInterrupt", ROM0[$0048]
LCDCInterrupt:: jp LCDCInterruptHandler_farCall

SECTION "ROM Bank $000 - TimerOverflowInterrupt", ROM0[$0050]
TimerOverflowInterrupt:: jp TimerOverflowInterruptStub

SECTION "ROM Bank $000 - SerialTransferCompleteInterrupt", ROM0[$0058]
SerialTransferCompleteInterrupt:: jp SerialTransferInterruptStub

SECTION "ROM Bank $000 - JoypadTransitionInterrupt", ROM0[$0060]
JoypadTransitionInterrupt::


SECTION "ROM Bank $000 - ROM Header", ROM0[$0100]
...
; ROM header is generated by rgbfix


SECTION "ROM Bank $000 - Main Section", ROM0[$0150]
...
mainGameLoop: ;{ 00:02CD
    ...
    ldh a, [hInputPressed]
    and PAD_BUTTONS ;$0f
    cp PAD_START | PAD_SELECT | PAD_B | PAD_A
        jp z, bootRoutine
...
handleCamera: ;{ 00:08FE
    ...
    jr z, .endIf_C
        ...
        ldh a, [hSamusXPixel]
        sub b
        add SCREEN_WIDTH_PX / 2 + OAM_X_OFS + samusOriginX_toCenter ; Adjusts math to be relative to the edge, not center, of the screen
    ...
    jr z, .endIf_G
        ...
        cp SCREEN_WIDTH_PX + OAM_X_OFS - $38
        jr nc, .else_H
        ...
        .else_H:
            ...
            cp SCREEN_WIDTH_PX + OAM_X_OFS - $38 + 1
            jr c, .endIf_G
    ...
    ldh a, [hSamusYPixel]
    sub b
    add SCREEN_HEIGHT_PX / 2 + OAM_Y_OFS + samusOriginY_toCenter - 2 ; Adjusts math to be relative to the edge, not center, of the screen
    ldh [hTemp.b], a
...
convertCameraToScroll: ;{ 00:2366
    ...
    ldh a, [hCameraYPixel]
    sub SCREEN_HEIGHT_PX / 2
    ld [scrollY], a
    ldh a, [hCameraXPixel]
    sub SCREEN_WIDTH_PX / 2
    ld [scrollX], a
    ; Handle earthquake
...
.start:
    ...
    ldh a, [hSamusYPixel]
    sub b
    add SCREEN_HEIGHT_PX / 2 + OAM_Y_OFS + samusOriginY_toCenter ; $62
    ldh [hTemp.a], a
